    ...
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <form action="{{ route('apar.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="id_apar" required class="w-full px-3 py-2 border rounded" placeholder="cth: A1.001">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-1">Kapasitas (Kg
