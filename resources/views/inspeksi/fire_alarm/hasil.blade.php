...
<head>
    ...
    <title>Dashboard Peralatan Tanggap Darurat UP2WI - FIRE ALARM</title>
...
<body id="main-body" class="bg-white text-gray-800">
    ...
    <div class="fixed max-w-6xl mx-auto px-4 mt-6">
        <a href="{{ route('fire_alarm.index', ['id_firealarm' => $firealarm->id_firealarm]) }}"
                    ...
                    @foreach ($pemeriksaans as $pemeriksaan)
                        @if (!empty($pemeriksaan->tanggal_pemeriksaan))
                            <tr>
                                ...
                                <td class="px-4 py-3">
                                    FIRE ALARM {{ $pemeriksaan->id_firealarm }} Bulan
                                    ...
                                    <div class="flex flex-wrap justify-center gap-2">
                                        ...
                                        @auth
                                            ...
                                            <form id="delete-form-{{ $pemeriksaan->id }}"
                                                  action="{{ route('pemeriksaan-fire_alarm.destroy', $pemeriksaan->id) }}"
...
function showDetail(data) {
        ...
        tableBody.innerHTML = `
            ...
            <tr>
                ...
                <td class="checkbox-group">
                    ...
                    <label class="option">
                        <span class="checkbox ${ (data.fungsi || '').toLowerCase() === 'tidak baik' ? 'checked tidak-baik' : '' }"></span>
                        Tidak Baik
                    </label>
                </td>
            </tr>
    ...
    const filename = 'Kartu Kendali FIRE ALARM ' + bulanTahun.replace(/\s+/g, ' ') + '.pdf';
    ...
    fetch(`/inspeksi/pemeriksaan-fire-alarm/${id}/edit-form`, {
