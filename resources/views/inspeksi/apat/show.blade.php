    ...
    <div class="max-w-6xl mx-auto px-4 mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
        <a href="{{ route('apat.inspeksi', ['id_apat' => $apat->id_apat]) }}"
           class="flex flex-col items-center justify-center bg-gray-100 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6">
            <img src="https://ik.imagekit.io/pln/apatins.png"
                 alt="Inspeksi Apat" class="h-28 md:h-36 object-contain">
        ...
        <a href="{{ route('apat.hasil', ['id_apat' => $apat->id_apat]) }}"
           class="flex flex-col items-center justify-center bg-gray-100 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6">
            <img src="https://ik.imagekit.io/pln/apathsl.png?updatedAt=1753502985667"
