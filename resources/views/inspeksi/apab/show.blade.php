    ...
    <div class="max-w-6xl mx-auto px-4 mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
        <a href="{{ route('apab.inspeksi', ['id_apab' => $apab->id_apab]) }}"
           class="flex flex-col items-center justify-center bg-gray-100 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6">
            <img src="https://ik.imagekit.io/pln/isnpeksi.png?updatedAt=1753164112273"
                 alt="Inspeksi Apab" class="h-28 md:h-36 object-contain">
        ...
        <a href="{{ route('apab.hasil', ['id_apab' => $apab->id_apab]) }}"
           class="flex flex-col items-center justify-center bg-gray-100 rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6">
            <img src="https://ik.imagekit.io/pln/hasil.png?updatedAt=1753164529941"
